...
namespace Public311
{
    public partial class NewServiceRequestPage : PhoneApplicationPage
    {
        ...
        private void LoadData()
        {
            ...
            {
                App.Public311Client.GetServiceDefinition((result) =>
                {
                    SmartDispatcher.BeginInvoke(() =>
                    {
                        ...
                        {
                            foreach (Public311.API.Models.Attribute item in CurrentService.attributes.OrderBy(z => z.order))
                            {
        ...
        private void PhotoChooserTask_Completed(object sender, PhotoResult e)
        {
            if (e.TaskResult == TaskResult.OK)
            {
                ...
                App.Public311Client.UploadImage((result) =>
                {
                    SmartDispatcher.BeginInvoke(() =>
                    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            App.Public311Client.CreateServiceRequest((result1) =>
            {
                SmartDispatcher.BeginInvoke(() =>
                {
                    GlobalLoading.Instance.IsLoading = false;
